...
describe('button icon styles', () => {
  ...
  (['outlined', 'contained', 'elevated'] as const).forEach((mode) =>
...
describe('getButtonColors - background color', () => {
  ...
  (['contained', 'elevated'] as const).forEach((mode) =>
    it(`should return correct disabled color, ${mode} mode`, () => {
      return expect(
        getButtonColors({
          customButtonColor,
  ...
  it('should return correct theme color, dark theme, contained mode', () => {
    expect(
      ...
      backgroundColor: getTheme(true).colors.onSurfaceVariant,
    });
  });
...
describe('getButtonColors - border color', () => {
  ...
  (['text', 'contained', 'elevated'] as const).forEach((mode) =>
